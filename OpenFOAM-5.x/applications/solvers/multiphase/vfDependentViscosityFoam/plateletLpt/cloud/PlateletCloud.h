...
protected:
    ...
    autoPtr<activationModel<plateletCloudType> > activationModel_;
...
public:
    ...
    // Member Functions
        ...
        // Access
            ...
            inline const typename parcelType::constantProperties& constProps() const
            {
                return constProps_;
            }
            ...
            const activationModel<plateletCloudType> & activation() const { return activationModel_(); }
